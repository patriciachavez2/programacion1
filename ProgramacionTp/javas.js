...
//Recordatorio : ver como usar la funcion en el innerText del case
    ...
    let tipoDeCereal = document.getElementById("tipoDeCereal");
    let ingresoCarga = document.getElementById("ingresoCarga");
    ...
    //SE DECLARA LA VARIABLE PARA GUARDAR EL TIPO DE CARGA QUE TRAE EL CAMION  / y se usa el toLowerCase para convertir todo el texto a minusculas
        document.getElementById("tipoDeCereal").addEventListener("input",function(){
        const valor = tipoDeCereal.value;
        console.log("El contenido del campo de entrada ha cambiado.0");
        resultado.innerText = `El resultado del input es ${valor}`
    });
